    ...
    (N.prototype = {
      ...
      parse: function (c) {
        for (var M, A, o, z = +c, b = this.offsets, a = this.untils, p = a.length - 1, n = 0; n < p; n++)
          if (((M = b[n]), (A = b[n + 1]), (o = b[n ? n - 1 : n]), M < A && R.moveAmbiguousForward ? (M = A) : o < M && R.moveInvalidForward && (M = o), z < a[n] - 6e4 * M))
            return b[n];
        return b[p];
      },
      abbr: function (c) {
  ...
  (b.tz = R),
    ...
    (b.updateOffset = function (c, M) {
      var A,
        o,
        z = b.defaultZone;
      void 0 === c._z && (z && C(c) && !c._isUTC && ((c._d = b.utc(c._a)._d), c.utc().add(z.parse(c), "minutes")), (c._z = z)),
        c._z && ((o = c._z.utcOffset(c)), Math.abs(o) < 16 && (o /= 60), void 0 !== c.utcOffset ? ((A = c._z), c.utcOffset(-o, M), (c._z = A)) : c.zone(o, M));
    }),
    (P.tz = function (c, M) {
      if (c) {
        if ("string" != typeof c) throw new Error("Time zone name must be a string, got " + c + " [" + typeof c + "]");
        return (
          (this._z = t(c)), this._z ? b.updateOffset(this, M) : S("Moment Timezone has no data for " + c + ". See http://momentjs.com/timezone/docs/#/data-loading/."), this
        );
      }
    ...
    (b.tz.setDefault = function (c) {
      return (
        (A < 2 || (2 == A && o < 9)) && S("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + b.version + "."),
