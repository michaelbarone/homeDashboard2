...
!(function (a, b, c) {
  ...
  b.module("ngIdle", ["ngIdle.keepalive", "ngIdle.idle", "ngIdle.countdown", "ngIdle.title", "ngIdle.localStorage"]),
    ...
    b.module("ngIdle.idle", ["ngIdle.keepalive", "ngIdle.localStorage"]).provider("Idle", function () {
      var a = { idle: 1200, timeout: 30, autoResume: "idle", interrupt: "mousemove keydown DOMMouseScroll mousewheel mousedown touchstart touchmove scroll", keepalive: !0 },
      ...
      (this.autoResume = function (b) {
        ...
        (this.$get = [
          ...
          function (e, f, g, h, i, j, k) {
            ...
            function s(a) {
              a ? j.set("expiry", { id: u, time: a }) : j.remove("expiry");
            }
            var t = { idle: null, timeout: null, idling: !1, running: !1, countdown: null },
              u = new Date().getTime(),
              v = {
                _options: function () {
                  return a;
                ...
                interrupt: function (b) {
                  return t.running
                    ? a.timeout && this.isExpired()
                      ? void p()
                      : void (("idle" === a.autoResume || ("notIdle" === a.autoResume && !t.idling)) && this.watch(b))
                    : void 0;
                }
              };
            h.find("body").on(a.interrupt, function () {
              v.interrupt();
            });
            var w = function (a) {
    ...
    b.module("ngIdle.localStorage", []).service("IdleLocalStorage", [
      "$window",
      function (a) {
