(function (angular) {
  ...
  angular.module("messageFormatExample", ["ngMessageFormat"]).controller("ckCtrl", function ($scope, $injector, $parse) {
    var people = [new Person("Alice", "female"), new Person("Bob", "male"), new Person("Charlie", "male")];
