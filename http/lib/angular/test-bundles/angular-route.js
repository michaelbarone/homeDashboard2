            ...
            function queueAnimation(originalElement, event, initialOptions) {
              ...
              $rootScope.$$postDigest(function () {
                ...
                var isValidAnimation =
                  parentElement.length > 0 && (animationDetails.event === "animate" || animationDetails.structural || hasAnimationClasses(animationDetails));
 ...
 */
  ...
  describe("ngView", function () {
    describe("basics", function () {
      ...
      it("should initialize view template after the view controller was initialized even when " + "templates were cached", function () {
        ...
        inject(function ($rootScope, $compile, $location, $httpBackend, $route) {
          ...
          $location.path("/foo");
          $httpBackend.expect("GET", "viewPartial.html").respond("<div ng-init=\"log.push('init')\">" + '<div ng-controller="ChildCtrl"></div>' + "</div>");
          $rootScope.$apply();
          $httpBackend.flush();
    ...
    describe("animations", function () {
      ...
      describe("hooks", function () {
        ...
        it("should fire off the leave animation", inject(function ($compile, $rootScope, $location, $templateCache, $timeout, $animate) {
          var item;
        ...
        it("should animate two separate ngView elements", inject(function ($compile, $rootScope, $templateCache, $location, $animate) {
          var item;
          $rootScope.tpl = "one";
          element = $compile(html("<div ng-view></div>"))($rootScope);
          $rootScope.$digest();
        ...
        it("should render ngClass on ngView", inject(function ($compile, $rootScope, $templateCache, $animate, $location) {
          var item;
          $rootScope.tpl = "one";
        ...
        it("should destroy the previous leave animation if a new one takes place", inject(function ($compile, $rootScope, $animate, $location, $timeout) {
  ...
  describe("$route", function () {
    ...
    it("should route and fire change event when catch-all params are used", function () {
      ...
      module(function ($routeProvider) {
        $routeProvider.when("/Book1/:book/Chapter/:chapter/:highlight*/edit", { controller: angular.noop, templateUrl: "Chapter.html" });
        $routeProvider.when("/Book2/:book/:highlight*/Chapter/:chapter", { controller: angular.noop, templateUrl: "Chapter.html" });
        $routeProvider.when("/Blank", {});
      });
      inject(function ($route, $location, $rootScope) {
        $rootScope.$on("$routeChangeStart", function (event, next, current) {
    ...
    it("should route and fire change event correctly whenever the case insensitive flag is utilized", function () {
      ...
      module(function ($routeProvider) {
        $routeProvider.when("/Book1/:book/Chapter/:chapter/:highlight*/edit", { controller: angular.noop, templateUrl: "Chapter.html", caseInsensitiveMatch: true });
        $routeProvider.when("/Book2/:book/:highlight*/Chapter/:chapter", { controller: angular.noop, templateUrl: "Chapter.html" });
        $routeProvider.when("/Blank", {});
      });
      inject(function ($route, $location, $rootScope) {
    ...
    describe("events", function () {
      ...
      it("should catch local factory errors", function () {
        ...
        inject(function ($location, $route, $rootScope) {
          ...
          expect($rootScope.$broadcast).toHaveBeenCalledWith("$routeChangeError", jasmine.any(Object), undefined, myError);
        });
      });
    });
