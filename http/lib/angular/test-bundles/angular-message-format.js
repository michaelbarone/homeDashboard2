...
*/
  ...
  describe("$$ngMessageFormat", function () {
    ...
    describe("$interpolate", function () {
      ...
      it("should return the interpolation object when there are no bindings and textOnly is undefined", inject(function ($interpolate) {
      ...
      describe("watching", function () {
        ...
        it("should stop watching strings with no expressions after first execution", inject(function ($interpolate, $rootScope) {
          var spy = jasmine.createSpy();
        ...
        it("should stop watching strings with only constant expressions after first execution", inject(function ($interpolate, $rootScope) {
          var spy = jasmine.createSpy();
      ...
      describe("interpolation escaping", function () {
        ...
        it("should not unescape markers within expressions", inject(function ($interpolate) {
          ...
          expect(function () {
            $interpolate("{{\\{\\{foo\\}\\}}}")(obj);
          }).toThrowMinErr("$parse", "lexerr", "Lexer Error: Unexpected next character  at columns 0-0 [\\] in expression [\\{\\{foo\\}\\}]");
        }));
