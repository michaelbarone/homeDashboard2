  ...
  describe("$$cookieWriter", function () {
    ...
    describe("put via $$cookieWriter(cookieName, string)", function () {
      ...
      it("should log warnings when 4kb per cookie storage limit is reached", inject(function ($log) {
        ...
        expect($log.warn.logs).toEqual([["Cookie 'x' possibly not set or overflowed because it was too large (4097 > 4096 " + "bytes)!"]]);
        ...
        if (document.cookie !== cookieStr) {
          this.fail(new Error("browser didn't drop long cookie when it was expected. make the " + "cookie in this test longer"));
        }
