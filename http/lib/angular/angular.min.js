...
(function (C) {
  ...
  function Ae(a, b) {
    ...
    d &&
      (Be
        ...
        : C.console.error("AngularJS: disabling automatic bootstrap. <script> protocol indicates an extension, document.location.href does not match."));
  }
  function Uc(a, b, d) {
    D(d) || (d = {});
    d = S({ strictDi: !1 }, d);
  ...
  function Fe() {
    ...
    if (!Wc) {
      ...
      (rb = z(b) ? C.jQuery : b ? C[b] : void 0) && rb.fn.on
        ? ((x = rb), S(rb.fn, { scope: Wa.scope, isolateScope: Wa.isolateScope, controller: Wa.controller, injector: Wa.injector, inheritedData: Wa.inheritedData }))
        : (x = Y);
      a = x.cleanData;
    ...
    function g(a) {
      ...
      r(a, function (a) {
        ...
        if (!m.get(a)) {
          ...
          try {
            A(a)
              ? ((c = kc(a)), (t.modules[a] = c), (b = b.concat(g(c.requires)).concat(c._runBlocks)), d(c._invokeQueue), d(c._configBlocks))
              : B(a)
              ? b.push(n.invoke(a))
              : H(a)
              ? b.push(n.invoke(a))
  ...
  function Ag(a, b, d, c, e) {
    ...
    h.url = function (b, d, e) {
      ...
      if (b) {
        ...
        !c.history || (k && f)
          ? (k || (qa = b),
            d ? l.replace(b) : k ? ((d = l), (e = b), (f = e.indexOf("#")), (e = -1 === f ? "" : e.substr(f)), (d.hash = e)) : (l.href = b),
            l.href !== b && (qa = b))
        ...
        function h(f, h, n, p) {
          ...
          for (var q, y, J = 0, I = [], P, Q = f.length, M = [], L = [], u; J < Q; )
            if (-1 !== (q = f.indexOf(a, J)) && -1 !== (y = f.indexOf(b, q + l)))
              J !== q && M.push(g(f.substring(J, q))), (J = f.substring(q + l, y)), I.push(J), (J = y + m), L.push(M.length), M.push("");
            else {
        ...
        if (!a.pur) {
          ...
          var c = a.value,
            c =
              ...
              ("function" === typeof c ? c.toString().replace(/ \{[\s\S]*$/, "") : z(c) ? "undefined" : "string" !== typeof c ? Ie(c, void 0) : c);
                      ...
                      if ((a = n[n.$$digestWatchIndex]))
                        if (((m = a.get), (g = m(q)) !== (h = a.last) && !(a.eq ? va(g, h) : X(g) && X(h))))
                          (s = !0),
                            ...
                            l(g, h === G ? g : h, q),
                            5 > r &&
                              ((z = 4 - r), N[z] || (N[z] = []), N[z].push({ msg: B(a.exp) ? "fn: " + (a.exp.name || a.exp.toString()) : a.exp, newVal: g, oldVal: h }));
                        else if (a === c) {
                          s = !1;
                          break a;
                        }
    ...
    this.$get = [
      ...
      function (d, c) {
        function e(a, b) {
          ...
          "self" === a
            ? (c = Bc(b, Od)) ||
              (C.document.baseURI ? (c = C.document.baseURI) : (Na || ((Na = C.document.createElement("a")), (Na.href = "."), (Na = Na.cloneNode(!1))), (c = Na.href)),
              (c = Bc(b, c)))
            : (c = !!a.exec(b.href));
          return c;
        }
  ...
  function ag() {
    this.$get = [
      ...
      function (a, b) {
        var d = {},
          c =
            !((!a.nw || !a.nw.process) && a.chrome && ((a.chrome.app && a.chrome.app.runtime) || (!a.chrome.app && a.chrome.runtime && a.chrome.runtime.id))) &&
            a.history &&
            a.history.pushState,
  ...
  Mb.prototype = {
    ...
    parse: function (a) {
      ...
      b.literal =
        0 === d.body.length ||
        (1 === d.body.length &&
          (d.body[0].expression.type === q.Literal || d.body[0].expression.type === q.ArrayExpression || d.body[0].expression.type === q.ObjectExpression));
  ...
  Rb.prototype = {
    ...
    $processModelValue: function () {
      var a = this.$$format();
      this.$viewValue !== a &&
        (this.$$updateEmptyClasses(a), (this.$viewValue = this.$$lastCommittedViewValue = a), this.$render(), this.$$runValidators(this.$modelValue, this.$viewValue, E));
    },
    $$format: function () {
              ...
              z
                ...
                : ((n.writeValue = function (a) {
                    if (v) {
                      ...
                      c
                        ? (k[0].value !== c.selectValue && (n.removeUnknownOption(), (k[0].value = c.selectValue), (c.element.selected = !0)),
        ...
        return {
          link: function (f, g, k) {
            ...
            f.$watch(l, function (b) {
              ...
              c === A ||
                (e && X(A)) ||
                (v(), (e = q[c]), z(e) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m), (v = E), h()) : (v = f.$watch(e, h)), (A = c));
            });
          }
        };
      }
    ...
    Bh = [
      ...
      function (a, b) {
        ...
        e.writeValue = function (b) {
          ...
          c && Oa(x(c), !1);
          e.hasOption(b)
            ? (e.removeUnknownOption(), (c = La(b)), a.val(c in e.selectValueMap ? c : b), Oa(x(a[0].options[a[0].selectedIndex]), !0))
