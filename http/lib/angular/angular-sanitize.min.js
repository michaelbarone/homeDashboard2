  ...
  c.module("ngSanitize", [])
    .provider("$sanitize", function () {
      ...
      this.addValidElements = function (a) {
        y || (H(a) && (a = { htmlElements: a }), t(l, a.svgElements), t(r, a.htmlVoidElements), t(m, a.htmlVoidElements), t(m, a.htmlElements));
        return this;
      };
      ...
      var z = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
        ...
        N = (function (a, e) {
          ...
          return c.querySelector("svg")
            ? ((c.innerHTML = '<svg><p><style><img src="</style><img src=x onerror=alert(1)//">'), c.querySelector("svg img") ? d : b)
            : function (b) {
                b = "<remove></remove>" + b;
                try {
                  b = encodeURI(b);
