 ...
 */ angular.module("ui.bootstrap", [
            ...
            (f.hasClass("collapse") && f.hasClass("in")) ||
              b.resolve(n(d)).then(function () {
                f.removeClass("collapse").addClass("collapsing").attr("aria-expanded", !0).attr("aria-hidden", !1),
                  e
                    ? e(f, { addClass: "in", easing: "ease", css: { overflow: "hidden" }, to: i(f[0]) })
                        .start()
                        ["finally"](k)
            ...
            return f.hasClass("collapse") || f.hasClass("in")
              ? void b.resolve(p(d)).then(function () {
                  f.css(i(f[0])).removeClass("collapse").addClass("collapsing").attr("aria-expanded", !1).attr("aria-hidden", !0),
                    e ? e(f, { removeClass: "in", to: t }).start()["finally"](m) : a.removeClass(f, "in", { to: t }).then(m);
                }, angular.noop)
              : m();
          }
          function m() {
          ...
          (o.addSlide = function (b, c) {
            p.push({ slide: b, element: c }),
              ...
              (b.index === a.active || (1 === p.length && !angular.isNumber(a.active))) &&
                (a.$currentTransition && (a.$currentTransition = null), (r = b.index), (a.active = b.index), f(r), o.select(p[h(b)]), 1 === p.length && a.play());
          }),
      ...
      function g(a) {
        ...
        if (e > -1) {
          ...
          for (var g = e; g < a.length; g++)
            f
              ? ("'" === a[g] && (g + 1 < a.length && "'" === a[g + 1] ? ((a[g + 1] = "$"), (c[g + 1] = "")) : ((c[g] = ""), (f = !1))), (a[g] = "$"))
              : "'" === a[g] && ((a[g] = "$"), (c[g] = ""), (f = !0));
          a = a.join("");
        }
        return (
        ...
        (this.parse = function (c, d, e) {
          ...
          if (j && j.length) {
            ...
            angular.isDate(e) && !isNaN(e.getTime())
              ...
              : (e && a.warn("dateparser:", "baseDate is not a valid date"), (m = { year: 1900, month: 0, date: 1, hours: 0, minutes: 0, seconds: 0, milliseconds: 0 }));
            ...
            return (
              k(m.year, m.month, m.date) &&
                (!angular.isDate(e) || isNaN(e.getTime()) || l
                  ? ((n = new Date(0)), s.call(n, m.year, m.month, m.date), u.call(n, m.hours || 0, m.minutes || 0, m.seconds || 0, m.milliseconds || 0))
                  : ((n = new Date(e)), s.call(n, m.year, m.month, m.date), u.call(n, m.hours, m.minutes, m.seconds, m.milliseconds))),
              n
            );
          }
        }),
                ...
                a.$watch("datepickerOptions." + b, function (a) {
                  a
                    ? angular.isDate(a)
                      ...
                      : (j && g.warn("Literal date support has been deprecated, please switch to date object usage"), (o[b] = new Date(h(a, "medium"))))
                  ...
                  ? a.$watch(
                      ...
                      function (c) {
                        (o[b] = a[b] = angular.isDefined(c) ? c : a.datepickerOptions[b]),
                          (("minMode" === b && o.modes.indexOf(a.datepickerOptions.datepickerMode) < o.modes.indexOf(o[b])) ||
                            ("maxMode" === b && o.modes.indexOf(a.datepickerOptions.datepickerMode) > o.modes.indexOf(o[b]))) &&
      ...
      return {
        ...
        position: function (c, d) {
          ...
          var g = this.offsetParent(c),
            h = { top: 0, left: 0 };
          return (
            g !== a[0].documentElement && ((h = this.offset(g)), (h.top += g.clientTop - g.scrollTop), (h.left += g.clientLeft - g.scrollLeft)),
            {
            ...
            K
              ...
              : ((G.$$parserName = "date"),
                ...
                G.$formatters.push(function (b) {
                  return G.$isEmpty(b)
                    ? ((a.date = b), b)
                    : (angular.isNumber(b) && (b = new Date(b)), (a.date = l.fromTimezone(b, H.getOption("timezone"))), l.filter(a.date, x));
                })),
              ...
              angular.forEach(["minDate", "maxDate"], function (b) {
                a.datepickerOptions[b]
                  ? angular.isDate(a.datepickerOptions[b])
                    ...
                    : (p && e.warn("Literal date support has been deprecated, please switch to date object usage"), (c[b] = new Date(k(a.datepickerOptions[b], "medium"))))
                  : (c[b] = null);
              }),
        ...
        this.keybindFilter = function (a) {
          if (d) {
            ...
            27 === a.which
              ...
              : d.isKeynavEnabled() && -1 !== [38, 40].indexOf(a.which) && d.isOpen && (e || g) && (a.preventDefault(), a.stopPropagation(), d.focusDropdownEntry(a.which));
          }
        };
      }
    ])
              ...
              function () {
                ...
                d.toggleClass(b, e),
                  !e &&
                    ...
                    v.heightOverflow &&
                    v.scrollbarWidth &&
                    (v.originalRight ? d.css({ paddingRight: v.originalRight + "px" }) : d.css({ paddingRight: "" }), (v = null)),
                  n(!0);
              },
              c.closedDeferred
            ),
        ...
        return (
          ...
          (z.open = function (b, f) {
            ...
            o >= 0 &&
              ...
              t.attr({ class: "modal-backdrop", "ng-style": "{'z-index': 1040 + (index && 1 || 0) + index*10}", "uib-modal-animation-class": "fade", "modal-in-class": "in" }),
              f.backdropClass && t.addClass(f.backdropClass),
              f.animation && t.attr("modal-animation", "true"),
              d(t)(u),
              a.enter(t, m),
              i.isScrollable(m) && ((v = i.scrollbarPadding(m)), v.heightOverflow && v.scrollbarWidth && m.css({ paddingRight: v.right + "px" })));
            var p;
            f.component
              ? ((p = document.createElement(j(f.component.name))),
                (p = angular.element(p)),
                p.attr({ resolve: "$resolve", "modal-instance": "$uibModalInstance", close: "$close($value)", dismiss: "$dismiss($value)" }))
              : (p = f.content),
                        ...
                        function (a) {
                          ...
                          e.component
                            ...
                            : e.controller &&
                              ...
                              e.controllerAs &&
                                e.bindToController &&
                                ((i = j.instance), (i.$close = g.$close), (i.$dismiss = g.$dismiss), angular.extend(i, { $resolve: r.$scope.$resolve }, d)),
                              (i = j()),
                        ...
                        V(),
                          ...
                          "none" !== N.show &&
                            N.show.forEach(function (a, c) {
                              "outsideClick" === a ? (b.on("click", j), h.on("click", B)) : a === N.hide[c] ? b.on(a, j) : a && (b.on(a, m), b.on(N.hide[c], q)),
                                b.on("keypress", C);
                            });
                      }
                      var E,
                            ...
                            (J ||
                              (J = g(
                                function () {
                                  ...
                                  E.hasClass(e[0]) || (E.removeClass(L.split("-")[0]), E.addClass(e[0])),
                                    E.hasClass(n.placementClassPrefix + a.placement) ||
                                      (E.removeClass(n.placementClassPrefix + L), E.addClass(n.placementClassPrefix + a.placement)),
                                    (K = g(
                                      function () {
                                    ...
                                    E.hasClass("uib-position-measure")
                                      ? (i.positionArrow(E, a.placement), E.removeClass("uib-position-measure"))
                                      : L !== a.placement && i.positionArrow(E, a.placement),
                                    (L = a.placement),
                                    (J = null);
                                },
                                0,
  ...
  angular
    ...
    .controller("UibTimepickerController", [
      ...
      function (a, b, c, d, e, f, g) {
        ...
        function r() {
          return (
            (null === a.hours || "" === a.hours) && (null === a.minutes || "" === a.minutes) && (!a.showSeconds || (a.showSeconds && (null === a.seconds || "" === a.seconds)))
          );
        }
        var s,
          t,
        ...
        c.secondStep &&
          ...
          (this.render = function () {
            ...
            isNaN(b)
              ...
              : (b && (v = b), C > v || v > D ? (x.$setValidity("time", !1), (a.invalidHours = !0), (a.invalidMinutes = !0)) : m(), n());
          }),
          ...
          (a.toggleMeridian = function () {
            var b = i(),
              c = h();
            a.noToggleMeridian() ||
              (angular.isDefined(b) && angular.isDefined(c) ? o(720 * (v.getHours() < 12 ? 60 : -60)) : (a.meridian = a.meridian === y[0] ? y[1] : y[0]));
          }),
          (a.blur = function () {
            x.$setTouched();
          }),
            ...
            (q = b),
              ...
              q.$formatters.push(function (b) {
                ...
                return (
                  ...
                  E ? ((e.$model = b), E(a, e)) : ((e[O.itemName] = b), (c = O.viewMapper(a, e)), (e[O.itemName] = void 0), (d = O.viewMapper(a, e)), c !== d ? c : b)
                );
              });
          });
      }
  ...
  angular.module("ui.bootstrap.typeahead").run(function () {
    !angular.$$csp().noInlineStyle &&
      ...
      angular.element(document).find("head").prepend('<style type="text/css">[uib-typeahead-popup].dropdown-menu{display:block;}</style>'),
