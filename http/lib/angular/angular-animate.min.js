        ...
        this.$get = [
          ...
          function (a, c, d, f, k, e, Q, L, x) {
            ...
            return function (a, b) {
                ...
                if (!P)
                  if (l.parentNode) {
                    var e = function (a) {
                      ...
                      h =
                        0 < aa &&
                        ((r.transitionDuration && 0 === X.transitionDuration) || (r.animationDuration && 0 === X.animationDuration)) &&
              ...
              0 < g.stagger
                ? ((B = parseFloat(g.stagger)), (X = { transitionDelay: B, animationDelay: B, transitionDuration: 0, animationDuration: 0 }))
                : (X = C(l, V, ka, Xa));
              ...
              if (p.applyTransitionDuration || p.applyAnimationDuration)
                (D = g.duration ? parseFloat(g.duration) : D),
                  p.applyTransitionDuration && ((p.hasTransitions = !0), (r.transitionDuration = D), (B = 0 < l.style[M + "Property"].length), y.push(La(D, B))),
                  p.applyAnimationDuration && ((p.hasAnimations = !0), (r.animationDuration = D), y.push([Ca, D + "s"]));
              ...
              R = 1e3 * D;
              g.skipBlocking ||
                ((p.blockTransition = 0 < r.transitionDuration), (p.blockKeyframeAnimation = 0 < r.animationDuration && 0 < X.animationDelay && 0 === X.animationDuration));
            ...
            return function (a, b, d, x) {
              ...
              function H(a, b, d, e, f) {
                ...
                if (0 === h.length) {
                  var k, q;
                  "beforeSetClass" === f
                    ? ((k = A(a, "removeClass", d, e, "beforeRemoveClass")), (q = A(a, "addClass", d, e, "beforeAddClass")))
